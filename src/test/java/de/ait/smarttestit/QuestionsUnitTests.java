...
import de.ait.smarttestit.services.impl.QuestionServiceImpl;
...
public class QuestionsUnitTests {
    ...
    class addQuestion {
        ...
        void addQuestion_PositiveTest() {
            ...
            when(questionsRepository.existsByQuestionTextAndTestTypeId(
        ...
        void addQuestion_NegativeTest() {
            ...
            assertThrows(RestException.class, () -> {
                questionService.addQuestion(testTypeId, newQuestion);
            });
        }
    }
    ...
    class getById {
        ...
        void testGetByIdOrThrow_returnsQuestion_whenIdExists() {
            ...
            verify(questionsRepository).findById(1L);
        ...
        void testGetByIdOrThrow_throwsRestException_whenIdDoesNotExist() {
            long questionId = 1L;
            when(questionsRepository.findById(questionId)).thenReturn(Optional.empty());

            RestException exception = assertThrows(RestException.class,
                    () -> questionService.getByIdOrThrow(questionId));

            verify(questionsRepository).findById(eq(questionId));
    ...
    class updateQuestion {
        ...
        void updateQuestion_PositiveTest() {
            ...
            Question existingQuestion = new Question(questionId,
                    "OldQuestion",
                    1,
                    null,
                    null);
            ...
            when(questionsRepository.save(any(Question.class))).thenReturn(existingQuestion);
            ...
            verify(questionsRepository).save(
        ...
        @Test
        public void updateQuestion_NegativeTest() {
    ...
    class deleteQuestion {
        ...
        void testDeleteQuestion_PositiveTest() {
            ...
            verify(questionsRepository, times(1)).delete(existingQuestion);
        }
        ...
        void testDeleteQuestion_WhenQuestionNotFound() {
            ...
            verify(questionsRepository, never()).delete(any());
        }
    }
}
